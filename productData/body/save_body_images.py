...
# JSON 파일 경로
JSON_PATH = "C:\\Users\\EZEN\\Documents\\data\\productData\\body\\body.json"

# 이미지 저장 기본 경로
SAVE_DIR = "C:\\Users\\EZEN\\Documents\\data\\productData\\body\\images"
...
def process_images():
    ...
    for data in data_list:
        ...
        # 폴더 경로 설정
        base_path = os.path.join(SAVE_DIR, "body", product_type, product_name)
