...
# JSON 파일 경로
JSON_PATH = "C:\\Users\\EZEN\\Documents\\data\\productData\\perfume\\perfume.json"

# 이미지 저장 기본 경로
SAVE_DIR = "C:\\Users\\EZEN\\Documents\\data\\productData\\perfume\\images"
...
def process_images():
    ...
    for data in data_list:
        product_type = data["type"].replace(" ", "_")
        product_name = data["name"].replace(" ", "_")

        # 폴더 경로 설정
        base_path = os.path.join(SAVE_DIR, "perfume", product_type, product_name)
