...
# 새로운 GitHub 정적 파일 레포지토리 URL
GITHUB_IMAGE_BASE_URL = "https://raw.githubusercontent.com/2mightyMt/diptyqueStatic1/main/images"
...
# JSON 파일 업데이트 경로 설정
updated_json_files = {
    "body": "productData/body/body_updated_final.json",
    "candle": "productData/candle/candle_updated_final.json",
    "diffuser": "productData/diffuser/diffuser_updated_final.json",
    "perfume": "productData/perfume/perfume_updated_final.json"
}
        ...
        for product in data:
            ...
            for option in product.get("options", []):
                ...
                if "thumbnail" in images:
                    images["thumbnail"]["default"] = f"{GITHUB_IMAGE_BASE_URL}/{category}/{product_name}/thumbnail/default.jpg"
                    images["thumbnail"]["hover"] = f"{GITHUB_IMAGE_BASE_URL}/{category}/{product_name}/thumbnail/hover.jpg"
                
                if "detail" in images:
                    images["detail"] = [
                        f"{GITHUB_IMAGE_BASE_URL}/{category}/{product_name}/detail/detail_{idx+1}.jpg"
